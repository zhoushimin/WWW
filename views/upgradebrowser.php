      ...
      <div class="centerbox-cont">
        ...
        <div class="btns">
          <a href="http://www.google.cn/chrome/" target="_blank">
            <img src="<?php echo static_file('web/img/chrome.png'); ?>" alt="chrome" />
            <h4>Google Chrome</h4>
          </a>
          <a href="http://www.mozilla.org/firefox/new/" target="_blank">
            <img src="<?php echo static_file('web/img/firefox.png'); ?>" alt="firefox" />
            <h4>Firefox</h4>
          </a>
          <a href="http://www.opera.com/" target="_blank">
            <img src="<?php echo static_file('web/img/opera.png'); ?>" alt="opera" />
            <h4>Opera</h4>
          </a>
        </div>
      </div>
